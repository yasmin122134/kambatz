...
export interface KitchenSchedulingRules {
  /** @deprecated — נקודות מטבח/חמגשיות תמיד לפי שעות (שדה נשמר לתאימות) */
...
export const SCHEDULER_FAIRNESS_EXPLANATION = [
  ...
  "נקודות תורנות — מימי מטבח/חמגשיות (לפי שעות).",
  "נקודות צדק = נקודות שמירה + נקודות תורנות.",
  "שמירה — 1 נק׳/שעה; לילה 1.25; בזוג 75% מסולו; תצפיתן 0.6.",
  "בונוס חוסר מנוחה בין שמירות לפי פער שעות [ ] כולל · ( ) לא כולל (למשל [4, 6) = +2).",

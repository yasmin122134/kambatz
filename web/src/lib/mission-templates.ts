...
export const STANDARD_GUARD_DAY_SUMMARY = [
  ...
  "כוח עתודה — 5 תמיד · קצין תורן — רני פלג ויסמין חדד יחד, משמרת אחת לאורך כל היום (2 מושבים)",
  "פטרולים — 6 סיורים לפי הפקודה, רק קצין תורן (רני / יסמין), 1 נק׳ שמירה לסיור · חוסם זמן",
  "חמגשיות — 5 צוערים ב־07–08, 12–13, 18–19, 1 נק׳ תורנות למשמרת",
] as const;
...
export const STANDARD_HAMAGSHIYOT_SUMMARY = [
  "בוקר 07:00–08:00 · צהריים 12:00–13:00 · ערב 18:00–19:00",
  "5 צוערים בכל חלון · 1 נק׳ תורנות למשמרת",
] as const;
